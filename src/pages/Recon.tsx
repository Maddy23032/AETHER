...
import { Globe, Play, Settings2, Terminal, ExternalLink, StopCircle, FileJson, FileText, FileCode, Download, Save } from "lucide-react";
          ...
          <div className="space-y-4">
            ...
            {isScanning ? (
              ...
              >
                ...
                {startScanMutation.isPending ? "Starting..." : "Launch Recon"}
              </Button>
            )}
